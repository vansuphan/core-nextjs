...
const AdminSlidesEditPage = ({ user }) => {
    ...
    const header = (
        <PageHeader pretitle="Slides" title="Update" button={<BackButton />} separator={true}>
            Cập nhật slide
        </PageHeader>
    );
...
export default withAuth(AdminSlidesEditPage);